...
<button className='bg-[#00df9a] text-black rounded-md font-medium my-6 mx-auto px-6 py-3'>Start Trial</button>
</div>
...
<button className='bg-black text-[#00df9a] rounded-md font-medium my-6 mx-auto px-6 py-3'>Start Trial</button>
</div>
<div className='w-full shadow-xl flex flex-col p-4 my-4 rounded-lg hover:scale-105 duration-300'>
